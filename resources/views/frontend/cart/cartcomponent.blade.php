 ...
 <form data-url="{{ route('order') }}" method="post" id="form_oder">
         ...
         <table class="table table-bordered border-primary">
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td style="width: 100px"><input class="form-control soluong" type="number" value="{{ $ac['soluong'] }}" min="1">
                     </td>
                     <td>
                     ...
                     <td style="width: 160px">
                         <div class="btn-group d-flex flex-wrap justify-content-between">
                             <a href="" data-id="{{ $key }}" data-url="{{ route('cart.update') }}" class="cart_update btn-primary fs-5 p-2 my-1 me-3">Cập nhật</a>
                             <a href="" data-id="{{ $key }}" data-url="{{ route('cart.delete') }}" class="del_cart btn-danger fs-5 p-2 my-1">Xóa</a>
                         </div>
                     </td>
                 </tr>
                 @endforeach
     ...
     <div class="col-lg-6">
         ...
         <div class="mb-4">
             ...
             <div class="my-2 d-flex align-items-center">
                 <input class="form-check-input fs-5" type="radio" name="gender" value="Nam" {{ (Auth::user()->gender ?? '') == 'Nam' ? 'checked' : '' }}><span class="mx-3 fs-5">Nam</span>
                 <input class="form-check-input fs-5" type="radio" name="gender" value="Nữ" {{ (Auth::user()->gender ?? '') == 'Nữ' ? 'checked' : '' }}><span class="mx-3 fs-5">Nữ</span>
             </div>
         ...
         <div class="mb-4">
             ...
             <div class="my-2 d-flex align-items-center">
                 <input class="form-check-input fs-5 me-3" type="radio" name="payment" value="Thanh Toán Khi Nhận Hàng" checked>
         ...
         <div class="mb-4">
             <span class="fs-5"> <i class="fas fa-map-marked-alt me-2"></i>Địa Chỉ :</span>
             <div class="my-2 d-flex align-items-center">
                 <input class="form-control" type="text" name="address" placeholder="số nhà, đường, phố, xã phường, quận huyện, tỉnh thành phố ...">
             </div>
             <p class="err_address text-danger fs-5"></p>
         </div>
         <div class="mb-4">
         ...
         <div class="mb-4">
             ...
             <div class="my-2 d-flex align-items-center">
                 <input class="form-check-input fs-5" type="radio" name="gender" value="Nam"><span class="mx-3 fs-5">Nam</span>
                 <input class="form-check-input fs-5" type="radio" name="gender" value="Nữ"><span class="mx-3 fs-5">Nữ</span>
             </div>
             <p class="err_gender text-danger fs-5"></p>
         </div>
         <div class="mb-4">
