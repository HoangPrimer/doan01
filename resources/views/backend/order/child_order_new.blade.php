<table class="table table-striped table-bordered border-primary " style="min-width: 1000px">
    ...
    <tbody>
        @foreach ($list_order_new as $key => $list)
        <tr>
            ...
            <td>
                @if ($list->od_status == 0)
                <button class="btn  text-light btn-secondary">Chờ duyệt</button>
            ...
            <td style="width: 125px">
                <a data-url="{{ route('order_details', $list->id) }}" class="btn btn-md btn-success details" title="Thông tin chi tiết">
                ...
                <div class="menu mt-2">
                    ...
                    <ul class="dropdown-menu menu-action">
                        ...
                        <li>
                            @if ($list->od_status == 0)
                            <a href="{{ route('action', ['id' => $list->id, '1']) }}">
                        ...
                        <li>
                            <a href="{{ route('action', ['id' => $list->id, '2']) }}">
                        ...
                        <li>
                            <a href="{{ route('action', ['id' => $list->id, '4']) }}" id="cancel_order_new" title="Hủy đơn">
