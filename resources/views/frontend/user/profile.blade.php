...
<section class="py-5">
            ...
            <div class="col-md-5 col-lg-4 info " style=" border-bottom-left-radius:10px">
                ...
                <div class="mb-3">
                    ...
                    <div class="info-item">
                        ...
                        @else
                        <span class="fs-5" id="phone">{{ Auth::user()->phone }}</span>
                        @endif
                        <i class="fs-5 fas fa-pencil-alt"></i>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 150px;">
                                        <a href="{{ route('user_order_details', $item->od_code) }}" style="width: 140px !important ;word-break: break-all" class="fs-5">
                                            #{{ $item->od_code }}
                                        </a>
                                    </td>
    ...
    <div class="update-profile">
        <form class="col-lg-6 col-sm-12 update" id="update_profile" data-url="{{ route('profiles') }}" enctype="multipart/form-data">
            @csrf
            <input type="text" value="{{ Auth::id() }}" name="id" hidden />
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="my-2">
                    ...
                    @else
                    <input class="form-control my-1" type="text" name="phone" value=" {{ Auth::user()->phone }}">
                    @endif
            ...
            <div class="mb-3">
                ...
                <div class="my-2">
                    ...
                    @else
                    <input class="form-control my-1" type="text" name="address" value=" {{ Auth::user()->address }}">
                    @endif
                    <p class="fs-5 err_address text-danger"></p>
                </div>
            </div>
            <div class="mt-3">
                <button type="submit" class="btn btn-lg text-light btn-success me-5"> Cập Nhật <i class="ms-2 fas fa-check"></i></button>
