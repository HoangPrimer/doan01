...
<section id="login">
    <div class="container  p-3">
        <div class="row">
            <div class="col-xl-8 col-lg-10 col-md-10 mx-auto border-show p-3">
                <form action=" {{ route('log') }}" method="post">
                    ...
                    <a class="btn btn-lg btn-warning dangky">Đăng Ký</a>
                </form>
            </div>
        </div>
    </div>
    <div class="login">
        <div class="container">
            <div class="col-xl-8 col-lg-10 col-md-10 mx-auto border border-primary p-3 bg-light shadow" style="border-radius: 10px">
