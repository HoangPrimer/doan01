    ...
    <div class="container border-show py-3">
        <div class=" row">
            <div class="col-lg-5 col-md-6 mt-3">
                <img class="img-fluid img_parent" src="{{ $product->Image()->value('img_file_path') }}" alt="loading" style="cursor: zoom-in">
...
<div class="modal fade" id="imgZoom">
    <div class="modal-dialog modal-dialog-centered " style="max-width: 800px;">
        <div class="modal-content  position-relative" style="background: none; border: none;cursor: pointer;">
            <i class="text-primary fas fa-chevron-left position-absolute top-50" style="z-index: 10000;font-size: 30px;left: 10px;"></i>
            <img src="" alt="" id="zoom" class="img-fluid">
            <i class="text-primary  fas fa-chevron-right position-absolute top-50 " style="z-index: 10000;font-size: 30px; right: 10px;"></i>
        </div>
    </div>
</div>
