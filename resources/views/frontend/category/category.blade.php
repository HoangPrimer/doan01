                            ...
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="trademark" value="{{$tra ->id}}"> {{$tra -> tr_name}}
                                    </label>
                                </div>
                            </li>
                            @endforeach
                    ...
                    <li class="fillter-item">
                        ...
                        <ul class="sub-fillter list-group" id="kieumay">
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="may" value="Quartz (Pin)"> Quartz (Pin)
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="may" value="Automatic"> Automatic
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="may" value="Năng Lượng Mặt Trời"> Năng Lượng Mặt Trời
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="may" value="Kinetic"> Kinetic
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="may" value="Lên Cót Tay"> Lên Cót Tay
                                    </label>
                                </div>
                            </li>
                        </ul>
                    ...
                    <li class="fillter-item">
                        ...
                        <ul class="sub-fillter list-group" id="day">
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="clday" value="Thép Không Gỉ"> Thép Không Gỉ
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="clday" value="Dây Da"> Dây Da
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="clday" value="Dây Vải"> Dây Vải
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="clday" value="Titanium"> Titanium
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="clday" value="Dây Cao Su"> Dây Cao Su
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input ckeck_product" id="clday" value="Dây Nhựa"> Dây Nhựa
                                    </label>
                                </div>
                            </li>
                        </ul>
                    ...
                    <li class="fillter-item">
                        ...
                        <ul class="sub-fillter list-group" id="size">
                            ...
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input ckeck_product" name="size" id="kichco" value="2"> Từ 30 mm - 34 mm
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input ckeck_product" name="size" id="kichco" value="3"> Từ 35 mm - 39 mm
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input ckeck_product" name="size" id="kichco" value="4"> Từ 40 mm - 43 mm
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input ckeck_product" name="size" id="kichco" value="5"> Trên 43 mm
                                    </label>
                                </div>
                            </li>
                        </ul>
