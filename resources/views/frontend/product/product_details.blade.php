        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="product__details--image">
                    <img src="{{ $a->Image()->value('img_file_path')}}" alt="loading" class="img_parent">
                </div>
                <div class="product__details--thumb">
                    @foreach($a->Image as $img)
                         <img src="{{$img->img_file_path}}" alt="" class="change_thumb">
                    @endforeach
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                ...
                <div class="info__bot">
                   <table>
                       <tr>
                           ...
                           <td class="right"><span>{{$a->ThuongHieu}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Nguồn Gốc:</span></td>
                           <td class="right"><span>{{$a->NguonGoc}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"> <span>Kiểu Máy:</span></td>
                           <td class="right"><span>{{$a->KieuMay}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Kích Cỡ (mm) :</span></td>
                           <td class="right"><span>{{$a->KichCo}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Độ Dày (mm):</span></td>
                           <td class="right"><span>{{$a->DoDay}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"> <span>Chất Liệu Vỏ:</span></td>
                           <td class="right"><span>{{$a->ChatLieuVo}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Chất Liệu Dây:</span></td>
                           <td class="right"><span>{{$a->ChatLieuDay}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Chất Liệu Kính:</span></td>
                           <td class="right"><span>{{$a->ChatLieuKinh}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Độ Chịu Nước (m):</span></td>
                           <td class="right"><span>{{$a->DoChiuNuoc}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Chức Năng :</span></td>
                           <td class="right"><span>{{$a->ChucNang}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Bảo Hành:</span></td>
                           <td class="right"><span>{{$a->BaoHanh}}</span></td>
                       </tr>
                       <tr>
                           <td class="left"><span>Giới Tính:</span></td>
                           <td  class="right"><span>{{$a->GioiTinh}}</span></td>
                       </tr>    
                    </table>
                </div>
            </div>
