    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <ul class="menu-sub1">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="">Giấy chứng nhận, giải thưởng</a></li>
            ...
            <div class="footer__share">
                <a href="" class="p-0">Đồng hồ chính hãng</a>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3">
            <div class="footer__logo">
                <img src="{{ asset('/image/default/logo_footer.png')}}">
                <img src="{{ asset('/image/default/logo_luxury.png')}}">
                <img src="{{ asset('/image/default/logo_tham_dinh.png')}}">
                <img src="{{ asset('/image/default/dathongbao.png')}}">
                <img src="{{ asset('/image/default/dmca_protected_21_120.png')}}">
            </div>
        </div>
        <div class="col-lg-9 col-md-9">
            ...
            <div class="footer__address">
                <div class="footer__address--tab">
                    <span class="tab-links act" onclick="changeaddress('region1',this)">HÀ NỘI</span>
                    <span class="tab-links" onclick="changeaddress('region2',this)">HỒ CHÍ MINH</span>
                </div>
