<table class="table table-striped table-bordered border-primary " style="min-width: 1000px">
    ...
    <tbody>
        @foreach ($list_order_cancel as $key => $list)
        <tr>
            ...
            <td style="width: 125px">
                ...
                <div class="menu mt-2">
                    ...
                    <ul class="dropdown-menu menu-action">
                        ...
                        <li>
                            <a class="nav-link disabled" href="{{ route('action', ['id' => $list->id, '3']) }}">
                                <i class="mx-2 text-success fas fa-check-double"></i></i> Đã Giao
                            </a>
                        </li>
                        <li>
                            <a class="nav-link disabled" href="{{ route('action', ['id' => $list->id, '4']) }}" id="cancel_order_new" title="Hủy đơn">
