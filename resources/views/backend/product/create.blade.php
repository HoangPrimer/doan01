        ...
        <form data-url="{{ route('post_create_product') }}" method="post" id="create_product">
            ...
            <div class="row mt-2 ">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <input type="text" class="form-control" name="pro_function" id="pro_function"
            ...
            <div class="row mt-2">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <input type="number" class="form-control" name="pro_price_entry" id="pro_price_entry"
                ...
                <div class="col-lg-5 col-md-6 col-sm-6">
                    ...
                    <div class="form-control">
                        ...
                        <input type="radio" class="form-check-input me-2" name="pro_gender" value="Nữ"><span
                            class="me-4">Nữ</span>
                        <input type="radio" class="form-check-input me-2" name="pro_gender" value="Cặp Đôi"
                            class="me-4"><span>Cặp Đôi</span>
                    </div>
