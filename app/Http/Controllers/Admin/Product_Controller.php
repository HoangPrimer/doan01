    ...
    public function post_create_product(Request $request)
    {
        $data = Validator::make(
            ...
            [
                ...
                'pro_source.required' => 'Vui lòng chọn nguồn gốc',
                'pro_manufacturing.required' => 'Vui lòng chọn nơi sản xuất',
