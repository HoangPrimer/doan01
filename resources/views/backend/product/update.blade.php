    ...
    <div class="card col-lg-12 p-2 ">
        <form data-url="{{ route('post_update_product', $update_product->id) }}" method="post" id="update_product">
            ...
            <div class="row mt-2">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <input type="text" class="form-control" name="pro_code" id="pro_code"
                        placeholder="{{ $update_product->pro_code }}">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <input type="text" class="form-control" name="pro_guarantee" id="pro_guarantee"
                        value="{{ $update_product->pro_guarantee }}">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mt-2">
                    ...
                    <input type="number" class="form-control" name="pro_price" id="pro_price"
                        value="{{ $update_product->pro_price }}">
                    <span class="text-danger err_pro_price fs-5"></span>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6  mt-2">
                    <label for="pro_sale">Giá Khuyến Mãi :</label>
                    <input type="number" class="form-control" name="pro_sale" id="pro_sale"
                        value="{{ $update_product->pro_sale }}">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6  mt-2">
                    ...
                    <input type="number" class="form-control" name="pro_amount" id="pro_amount"
                        value="{{ $update_product->pro_amount }}">
            ...
            <div class="form-group mt-3">
                ...
                <textarea name="pro_desc" class="ckeditor form-control"
